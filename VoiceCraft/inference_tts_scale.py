...
def get_args():
    ...
    parser.add_argument("--manifest_fn", type=str, default="/home/aix23606/jiyoung/ADD/VoiceCraft/manifest.tsv")
    parser.add_argument("--audio_root", type=str, default="/mnt/aix23606/jiyoung/ADD/DS_VoxCeleb/longest_one")
    parser.add_argument("--exp_dir", type=str, default="/home/aix23606/jiyoung/ADD/VoiceCraft")
    ...
    parser.add_argument("--output_dir", type=str, default="/mnt/aix23606/jiyoung/ADD/DS_E06_VoiceCraft/flac")
    parser.add_argument("--device", type=str, default="cuda")
    parser.add_argument("--signature", type=str, default="/home/aix23606/jiyoung/ADD/VoiceCraft/encodec_4cb2048_giga.th", help="path to the encodec model")
...
def get_model(exp_dir, device=None):
    ...
    ckpt_fn = os.path.join(exp_dir, "330M_TTSEnhanced.pth")
    ckpt = torch.load(ckpt_fn, map_location='cpu')

    model_args = ckpt['args']
    model_state = ckpt['model']
    phn2num = ckpt.get('phn2num', None)
...
'''
def get_model1(exp_dir, device=None):

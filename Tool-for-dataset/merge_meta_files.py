...
if __name__ == "__main__":
    meta_dir = r'/Volumes/System/MeloTTS/wikipedia/metadata'  # 메타데이터 파일들이 들어 있는 폴더
    output_file = r'/Volumes/System/MeloTTS/wikipedia/old_melotts_wiki_meta.txt'  # 결과를 저장할 파일

...
if __name__ == "__main__":
    meta_dir = r'/mnt/aix23606/jiyoung/ADD/DS_Ours/db05/metadata'  # 메타데이터 파일들이 들어 있는 폴더
    output_file = r'/mnt/aix23606/jiyoung/ADD/DS_Ours/db05/train_meta.txt'  # 결과를 저장할 파일
